...
<body background="images/fondo.png" style="background-attachment: fixed" >
    ...
    <center> <input  class="btn btn-info" type="submit" onclick="location.href='verinternojuzdir.php'" name="submit" value="VOLVER"/>  
...
$recibir =$_POST['buscar'];
  ...
  if ($recibir != "") {
$sql=("SELECT * FROM internos INNER JOIN delito on internos.idDelito=delito.id_delito INNER JOIN ubicacion on internos.idubicacion=ubicacion.id_ubicacion WHERE internos.Juzgado LIKE '%$recibir%' order by internos.Apynombre");
