...
<body background="images/fondo.png" style="background-attachment: fixed" >
    ...
    <center> <input  class="btn btn-info" type="submit" onclick="location.href='index3.php'" name="submit" value="VOLVER"/></center>   
    <br>
    <br>
...
<center> <input class="printbutton" type="submit" name="submit" alt="imprimir"  value="IMPRIMIR" >  <input  class="btn btn-danger" type="submit" onclick="location.href='historialdir.php'" name="submit" value="HISTORIAL"/></center>   
</center>   
<br><br>
