...
<center><form class="w3-container w3- blue" action="verinternojuz1dir.php" method="POST">
  <input class="w3-input w3-border w3-round" name="buscar" placeholder="Buscar..Ingrese Juzgado" type="search-content-box"required><br>
  <p>
