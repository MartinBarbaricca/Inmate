...
<body background="images/fondo.png" style="background-attachment: fixed" >
    ...
    <center> <input  class="btn btn-info" type="submit" onclick="location.href='verinternodir.php'" name="submit" value="VOLVER"/>  
...
$recibir =$_POST['buscar'];
  ...
  if ($recibir != "") {
$sql=("SELECT * FROM internos INNER JOIN delito on internos.idDelito=delito.id_delito INNER JOIN ubicacion on internos.idubicacion=ubicacion.id_ubicacion WHERE internos.Apynombre LIKE '%$recibir%'");
 ...
 
{
  ...
  location.href="verinternodir.php";
  </script> ';
