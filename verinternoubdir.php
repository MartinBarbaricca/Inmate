...
<center><form class="w3-container w3- blue" action="verinternoub1dir.php" method="POST">
  <input class="w3-input w3-border w3-round" name="buscar1" placeholder="Buscar..Ingrese ubicacion" type="search-content-box"required><br>
  <p>
